...
import { sizeToComponentHeight, sizeToFontSize, sizeToTextLineHeight, stateColor } from '../config';
...
export type BaseInputPropsType = Readonly<ExtractPropTypes<typeof BaseInputProps>>;
...
export interface BaseInputTheme extends ThemeConfig {
    bemModifiers: string[];
    colors: {
        text: Color;
        border: Color;
...
export const obtainBaseInputTheme = <E extends EmitsOptions>(
    ctx: InternalSetupContext<BaseInputPropsType, E>,
...
export const useBaseInput = <E extends EmitsOptions>(ctx: InternalSetupContext<BaseInputPropsType, E>, opperatorData?: OpperatorData) => {
