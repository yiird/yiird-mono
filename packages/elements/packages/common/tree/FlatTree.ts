...
import type { TreeNodeKey, TreeNodeMapping } from '../common-source';
import { appendToSet } from '../common-util';
import { isStateIcons, isTypeIcons, operatorCheck, operatorExpand } from './util';
...
export class FlatTree {
    ...
    constructor(originalData: Array<any>, mapping: TreeNodeMapping, options: FlatTreeOptions) {
