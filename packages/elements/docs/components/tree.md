...
| icon                   | 主要图标<hr>默认值:<br><pre>faFolder</pre>                                                                                                                                                                                                       |   IconNameOrDefinition  |                                                                                                                         |
| icon-actived           | 主要图标<hr>默认值:<br><pre>faFolderOpen</pre>                                                                                                                                                                                                   |   IconNameOrDefinition  |                                                                                                                         |
| leaf-icon              | 叶子结点图标<hr>默认值:<br><pre>faFile</pre>                                                                                                                                                                                                     |   IconNameOrDefinition  |                                                                                                                         |
| switch-icons           | <hr>默认值:<br><pre>default () {<br>  return [faSquareCheck, faSquare, faSquareMinus];<br>}</pre>                                                                                                                                                |   IconNameOrDefinition  |                                                                                                                         |
