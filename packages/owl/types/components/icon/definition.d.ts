 ...
 * 图标前缀
 */
export declare type IconPrefix = 'fas' | 'far' | 'fal' | 'fat' | 'fad' | 'fab' | 'fak';
export declare type IconSize = 'xs' | 'sm' | 'lg' | NumberSize;
export declare type IconRotation = 90 | 180 | 270 | '90' | '180' | '270' | null;
export declare type IconFlip = 'horizontal' | 'vertical' | 'both';
export declare type IconAnimation = 'beat' | 'fade' | 'beat-fade' | 'bounce' | 'flip' | 'shake' | 'spin' | 'spin-pulse' | 'spin-reverse' | 'spin-pulse-reverse';
/**
 * 动画配置选项
 */
