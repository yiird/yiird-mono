<template>
	<button v-if="refresh__" v-show="display__" :id="id__" v-bind="$attrs" ref="rootRef" :class="class__">
		...
		<slot v-if="true" :key="1" name="aa1" aa="11" :arg0="size" :arg1="{ a: 1, b: 2 }"></slot>

		<!-- 这是一个slot -->

		<!-- @param {String} arg0 参数描述 -->
		<!-- @param {String} arg1 参数描述 -->
		<slot v-if="true" :key="1" name="aa2" aa="11" :arg0="size" :arg1="{ a: 1, b: 2 }"></slot>
	</button>
</template>
<script lang="ts">
import { defineComponent } from 'vue';
import { withButton } from './logic-button';
...
export default defineComponent({
	...
	methods: {
		...
		fn1(arg1: Arg1, arg2: string) {
			/**
			 * 事件说明
			 * @argument {String} arg1 - aaa
			 */
			this.$emit('event-name', arg1);
			return 0;
		},
		/**
		 * fn2 方法定义说明
