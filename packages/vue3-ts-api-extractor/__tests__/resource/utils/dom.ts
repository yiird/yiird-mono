 ...
 * @public
 */
export type ClsType = undefined | string | Array<string | Ref> | Record<string, boolean> | Ref;
 ...
 * @internal
 */
export const _cssVar = function (this: void | unknown, name: string, value: unknown, prefix = true): void {
