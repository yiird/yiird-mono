...
export type ORawBinding<E = Record<string, unknown>, P = Record<string, unknown>> = E & P & OPrefabExpose & OPrefabPrivate;

/**
 * owl组件实例定义
 * @public
 */
export type OComponentInstance<Props = Record<string, unknown>, RawBinding extends ORawBinding = ORawBinding> = ComponentPublicInstance<Props, RawBinding>;

export type OPropsType<T> = Readonly<ExtractPropTypes<T>>;
